...
//START ALPHA CHANGE 2539 -- remove old Uniswap plan generated model files from trading API type modifier --
const nullablePermitFile = project.addSourceFileAtPath(`${path}/NullablePermit.ts`)
//FINISH ALPHA CHANGE 2539 -- remove old Uniswap plan generated model files from trading API type modifier --
...
function main() {
  ...
  //START ALPHA CHANGE 2540 -- remove old Uniswap PlanResponse generated type mutation --
  //FINISH ALPHA CHANGE 2540 -- remove old Uniswap PlanResponse generated type mutation --
  ...
  saveFiles({
    files: [
      requestFiles,
      responseFiles,
      //START ALPHA CHANGE 2541 -- stop saving old Uniswap plan generated model files --
      routingFile,
      nullablePermitFile,
      orderTypeFile,
      orderStatusFile,
      chainedQuoteFile,
      //FINISH ALPHA CHANGE 2541 -- stop saving old Uniswap plan generated model files --
    ]
