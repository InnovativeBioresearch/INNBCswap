...
const createAssetModuleMock = (filename: string) => {
  ...
  if (extension === 'svg') {
    //START ALPHA CHANGE 3703 -- remove unused svg mock props rest parameter --
    const MockedSvgComponent = React.forwardRef(({ children }: any, ref: any) => {
      return React.createElement('svg', { ref, 'data-testid': 'mocked-svg' }, children)
    })
    //FINISH ALPHA CHANGE 3703 -- remove unused svg mock props rest parameter --
...
//START ALPHA CHANGE 3704 -- remove unused Unicon mock props parameter --
vi.mock('ui/src/components/Unicon', () => ({
  Unicon: () => {
    return React.createElement('span', { 'data-testid': 'unicon' }, '🔵')
  },
}))
//FINISH ALPHA CHANGE 3704 -- remove unused Unicon mock props parameter --


vi.mock('ui/src/assets', () => ({
  //START ALPHA CHANGE 3702 -- remove stale all-networks asset mock after public logo migration --
  //FINISH ALPHA CHANGE 3702 -- remove stale all-networks asset mock after public logo migration --
